...
export default function AboutPage() {
  ...
  return (
    <div ref={containerRef} className="overflow-x-hidden">
      ...
      <section className="about-hero flex flex-col justify-center items-center text-center px-6">
        <p className="about-label mb-4">About Us</p>

        <h1 className="about-title mb-6">Raj Caterers</h1>
        ...
        <div className="about-description">
          <p>
            ...
            strong emphasis on quality, hospitality, and attention to detail, we
            have earned the trust of clients by consistently delivering
      ...
      <section className="exp-section py-20 px-6">
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8 text-center">
          <div className="experience-card p-6 rounded-xl bg-white/5 border border-white/10">
            <h3 className="text-4xl font-bold text-yellow-400 drop-shadow-[0_0_12px_rgba(212,175,55,0.6)]">
              20+
            </h3>
            <p className="text-gray-300 mt-2 text-yellow-400 drop-shadow-[0_0_12px_rgba(212,175,55,0.6)]">
              Years of Experience
            </p>
          </div>

          <a href="tel:+919334127247" className="block">
            <div className="experience-card p-6 rounded-xl bg-white/5 border border-white/10 cursor-pointer hover:scale-105 transition duration-300">
              <h3 className="text-xl font-semibold text-yellow-400 drop-shadow-[0_0_12px_rgba(212,175,55,0.6)]">
                Call Us
              </h3>
          ...
          <a href="mailto:rajcaterer247@gmail.com" className="block">
            <div className="experience-card p-6 rounded-xl bg-white/5 border border-white/10 cursor-pointer hover:scale-105 transition duration-300">
              <h3 className="text-xl font-semibold text-yellow-400 drop-shadow-[0_0_12px_rgba(212,175,55,0.6)]">
                Email
              </h3>
    ...
    "
          >
            ...
            elegant presentation, and heartfelt hospitality to every
            celebration. Over the years, we have successfully catered weddings,
            corporate events, and private gatherings, earning the trust of our
            clients through quality service and attention to detail.
          </p>
  ...
  "
            >
              With a passion for culinary excellence and event perfection, our
              founder has dedicated years to building Raj Caterers into a
              trusted name in the catering industry. His commitment to quality,
              innovation, and customer satisfaction continues to inspire our
              team every day.
            </p>
